...
public class CollectionFriendFragment extends Fragment {

    private WebView mWebView;

	public CollectionFriendFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.setWebViewClient(WebViewClientFactory.FriendCollectionViewer);
        mWebView.loadUrl(Global.getLastCollectionURL());
